...
<g id="dz-bg-layer">
  ...
  <text x="700" y="40" font-family="'Courier New',monospace" font-size="21" font-weight="bold" fill="#c9a84c" text-anchor="middle" letter-spacing="4">P.O.L.A.R.I.S. ENERGY CHAIN</text>
  <text x="700" y="58" font-family="'Courier New',monospace" font-size="9.5" fill="#4fc3f7" text-anchor="middle" letter-spacing="1" opacity="0.8">Solar · Mirrors · Capture · Conversion · LASER · L4/L5 · Transmission · Reception · Star Power Grid</text>
  ...
  <text x="700" y="97" font-family="'Courier New',monospace" font-size="7.5" fill="#4fc3f7" text-anchor="middle" opacity="0.45" letter-spacing="1">cumulative energy losses  →</text>
  ...
  <g font-family="'Courier New',monospace" font-size="8" text-anchor="middle">
    ...
    <text x="75"   y="441" fill="#ff9a3c" opacity="0.6">input</text><text x="231"  y="441" fill="#ffa040" opacity="0.6">mirrors</text>
    <text x="387"  y="441" fill="#c9a84c" opacity="0.6">GaAs PV</text><text x="543"  y="441" fill="#4fc3f7" opacity="0.6">laser</text>
    <text x="700"  y="441" fill="#00e5ff" opacity="0.6">emission</text><text x="856"  y="441" fill="#ce93d8" opacity="0.6">L4/L5</text>
    <text x="1012" y="441" fill="#4fc3f7" opacity="0.6">atmosphere</text><text x="1168" y="441" fill="#69f0ae" opacity="0.6">rectenna</text>
  ...
  <text x="700" y="486" font-family="'Courier New',monospace" font-size="9.5" fill="#c9a84c" text-anchor="middle">OVERALL SYSTEM EFFICIENCY</text>
  <text x="700" y="503" font-family="'Courier New',monospace" font-size="8.5" fill="#4fc3f7" text-anchor="middle" opacity="0.85">0.90 × 0.45 × 0.60 × 0.90 × 0.85 ≈ 18–20%  ·  24/7 capture  ·  no weather intermittency</text>
  <rect x="755" y="530" width="290" height="32" rx="4" fill="#0a0818" stroke="#ce93d8" stroke-width="0.7" opacity="0.85"/>
  <text x="900" y="546" font-family="'Courier New',monospace" font-size="8" fill="#ce93d8" text-anchor="middle">LAGRANGE L4/L5: gravitational equilibrium points</text>
  <text x="900" y="558" font-family="'Courier New',monospace" font-size="7.5" fill="#9c6aad" text-anchor="middle" opacity="0.8">Sun–Earth · long-term stability without propulsion</text>
  <rect x="1070" y="530" width="310" height="32" rx="4" fill="#0a1a08" stroke="#69f0ae" stroke-width="0.7" opacity="0.85"/>
  <text x="1225" y="546" font-family="'Courier New',monospace" font-size="8" fill="#69f0ae" text-anchor="middle">STAR POWER GRID: P.O.L.A.R.I.S. terrestrial extension</text>
  <text x="1225" y="558" font-family="'Courier New',monospace" font-size="7.5" fill="#4fc3f7" text-anchor="middle" opacity="0.8">radial distribution from North Pole + South Pole · HVDC YBCO</text>
  <line x1="200" y1="648" x2="1200" y2="648" stroke="#c9a84c" stroke-width="0.4" opacity="0.22"/>
  <text x="700" y="660" font-family="'Courier New',monospace" font-size="9.5" fill="#c9a84c" text-anchor="middle" opacity="0.5" letter-spacing="2">POLARIS BEARS · Innovating the present. Powering the future!</text>
</g>
...
<g id="dz-conn-12">
  ...
  <text x="153" y="280" font-family="'Courier New',monospace" font-size="7" fill="#ffa040" text-anchor="middle" opacity="0.65">concentrated photons</text>
</g>
<g id="dz-conn-23">
  ...
  <text x="309" y="280" font-family="'Courier New',monospace" font-size="7" fill="#c9a84c" text-anchor="middle" opacity="0.65">IR/VIS flux</text>
</g>
<g id="dz-conn-34">
  ...
  <text x="465" y="280" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.65">DC current</text>
</g>
<g id="dz-conn-45">
...
<g id="dz-conn-67">
  ...
  <text x="934" y="280" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.75">stable beam</text>
</g>
<g id="dz-conn-78">
  ...
  <text x="1090" y="280" font-family="'Courier New',monospace" font-size="7" fill="#69f0ae" text-anchor="middle" opacity="0.65">received</text>
</g>
<g id="dz-conn-89">
  ...
  <text x="1246" y="280" font-family="'Courier New',monospace" font-size="7" fill="#ffe066" text-anchor="middle" opacity="0.75">YBCO cable</text>
</g>
...
<g id="dz-node-1" transform="translate(75,290)">
  ...
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#ff9a3c" text-anchor="middle">SOLAR SOURCE</text>
  <text x="0" y="73" font-family="'Courier New',monospace" font-size="8" fill="#ff9a3c" text-anchor="middle" opacity="0.8">1361 W/m²</text>
  <text x="0" y="85" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.55">solar constant</text>
...
<g id="dz-node-2" transform="translate(231,290)">
  ...
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#ffa040" text-anchor="middle">SOLAR MIRRORS</text>
  <text x="0" y="73" font-family="'Courier New',monospace" font-size="8" fill="#ffa040" text-anchor="middle" opacity="0.8">30 mirrors · Ø1km</text>
  <text x="0" y="85" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.55">at 7M km · η≈90%</text>
...
<g id="dz-node-3" transform="translate(387,290)">
  ...
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#c9a84c" text-anchor="middle">ORBITAL CAPTURE</text>
  <text x="0" y="73" font-family="'Courier New',monospace" font-size="8" fill="#c9a84c" text-anchor="middle" opacity="0.8">GaAs panel · η≈45%</text>
  <text x="0" y="85" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.55">no atmospheric losses</text>
...
<g id="dz-node-4" transform="translate(543,290)">
  ...
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#4fc3f7" text-anchor="middle">CONVERSION</text>
  <text x="0" y="73" font-family="'Courier New',monospace" font-size="8" fill="#4fc3f7" text-anchor="middle" opacity="0.8">laser diode · η≈60%</text>
  <text x="0" y="85" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.55">YBCO superconductor</text>
...
<g id="dz-node-5" transform="translate(700,290)">
  ...
  <line x1="19" y1="5"  x2="40" y2="8"  stroke="#00e5ff" stroke-width="1.5" opacity="0.55"/>
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#00e5ff" text-anchor="middle">LASER EMISSION</text>
  <text x="0" y="73" font-family="'Courier New',monospace" font-size="8" fill="#00e5ff" text-anchor="middle" opacity="0.8">1064 nm · IR</text>
  <text x="0" y="85" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.55">divergence &lt;0.001°</text>
...
<g id="dz-node-6" transform="translate(856,290)">
  ...
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#ce93d8" text-anchor="middle">LAGRANGE NODE</text>
  <text x="0" y="73" font-family="'Courier New',monospace" font-size="8" fill="#ce93d8" text-anchor="middle" opacity="0.8">L4 / L5 · orbital relay</text>
  <text x="0" y="85" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.55">stabilization · correction</text>
...
<g id="dz-node-7" transform="translate(1012,290)">
  ...
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#4fc3f7" text-anchor="middle">TRANSMISSION</text>
  <text x="0" y="73" font-family="'Courier New',monospace" font-size="8" fill="#4fc3f7" text-anchor="middle" opacity="0.8">atmosphere · η≈90%</text>
...
<g id="dz-node-8" transform="translate(1168,290)">
  ...
  <text x="0" y="60" font-family="'Courier New',monospace" font-size="9.5" font-weight="bold" fill="#69f0ae" text-anchor="middle">RECEPTION</text>
  ...
  <text x="0" y="85" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.55">laser → DC current</text>
...
<g id="dz-node-9" transform="translate(1324,290)">
  ...
  <text x="0" y="76" font-family="'Courier New',monospace" font-size="7.5" fill="#ffe066" text-anchor="middle" opacity="0.85">radial distribution</text>
  <text x="0" y="88" font-family="'Courier New',monospace" font-size="7" fill="#4fc3f7" text-anchor="middle" opacity="0.6">poles → continents · HVDC</text>
  ...
  return (
    <div ref={sectionRef} className={styles.section}>
      <div className={styles.sticky}>
        <p className={styles.label}>The complete energy chain</p>
        <div
          ref={wrapRef}
