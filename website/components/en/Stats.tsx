...
const STATS = [
  { value: 1.6,   decimals: 1, suffix: ' TW',  label: 'power delivered',          sub: '≈ 48% of global electricity' },
  { value: 48,    decimals: 0, suffix: '%',     label: 'of global electricity',    sub: 'for a Kardashev 1 civilization' },
  { value: 800,   decimals: 0, suffix: ' GW',   label: 'per YBCO cable',           sub: 'superconductor at 77K — liquid nitrogen' },
  { value: 30,    decimals: 0, suffix: '',       label: 'Dyson mirrors',            sub: 'Ø 1 km · 7 million km from the Sun' },
  { value: 4,     decimals: 0, suffix: '',       label: 'collector satellites',     sub: '43% laser efficiency · solar orbit' },
  { value: 622000,decimals: 0, suffix: ' W/m²', label: 'solar intensity',          sub: "457× that of Earth's surface" },
]
  ...
  return (
    <section id="numbers" ref={sectionRef} className={styles.section}>
      ...
      <div data-header className={styles.header}>
        <p className={styles.label}>Key data</p>
        <h2 className={styles.heading}>The numbers that matter</h2>
      </div>
